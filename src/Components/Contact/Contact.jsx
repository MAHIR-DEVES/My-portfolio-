...
const Contact = () => {
  ...
  return (
    <section id="contact">
      <div className="bg-[#0d1321] text-white py-5 px-4 sm:px-0">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent text-left">
              Get In Touch
            </h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-600  rounded-full"></div>
            <p className="mt-6 text-lg text-gray-300 text-left">
